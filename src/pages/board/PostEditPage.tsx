...
export function PostEditPage() {
  ...
  const { selectedPost, fetchPostById, updatePost, isLoading, error } = usePostStore();
  ...
  useEffect(() => {
    ...
    if (selectedPost) {
      if (!user || user.id !== selectedPost.author_id) {
        // User is not the author, redirect to detail page
        navigate(`/posts/${id}`);
        return;
      }
